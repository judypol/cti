...
namespace PLAgentBar
{
	internal class ListViewColumnSorter : IComparer
	{
		...
		public int Compare(object x, object y)
		{
			...
			int compareResult = this.ObjectCompare.Compare(Convert.ToUInt64(listviewX.SubItems[this.ColumnToSort].Text), Convert.ToUInt64(listviewY.SubItems[this.ColumnToSort].Text));
			int result;
